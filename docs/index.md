...
| Understand Hard Abort and recovery | [Quality Gate & Hard Abort](quality_gate_addendum.md) → [Re-Convergence](reconvergence.md) |
| Use an audit-ready session template | [Protocol Template](protocol_template.md) |
...
- [Re-Convergence — Identity Recovery](reconvergence.md)
