...
C may mediate A toward high-density regions of the training distribution.
The anchor constrains toward a specific validated identity.
Identity stability emerges when reconstruction remains within validated gate criteria under anchor-supported conditions.

> CIP does not eliminate drift.
> It governs adoption and failure handling under probabilistic constraints.
