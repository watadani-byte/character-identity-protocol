...
> CIP governs validation and adoption decisions. PAL supports persistence and continuity.
...
*Related: [Technical Mechanism](technical_mechanism.md) — [White Paper](whitepaper_v1.md) — [PAL Hypothesis Document](pal_hypothesis.md)*- Session reset no longer implies complete practical identity loss
