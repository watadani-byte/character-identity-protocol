...
> This appendix is observational in nature.
...
The main drift categories are defined in [Character Drift Taxonomy](character_drift_taxonomy.md).
...
**Description**
Short description of the observed behavior.

**Observed Behavior**
Explanation of how the drift manifests during generation.

**Example**
Reference images or generation conditions if available.

**Notes**
Additional remarks or hypotheses.
...
*See also: [Character Drift Taxonomy](character_drift_taxonomy.md) — [Technical Mechanism](technical_mechanism.md)*